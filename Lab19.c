/*
 ...
 - Pointers arithmatic operation
 - Pointer address increments 
 ============================================================================
*/
#include <stdio.h>
...
int main()
{
	...
	printf("the value of mychar is now 0x%p.\n",&mychar);
	printf("the value of char_ptr is now 0x%p.\n",char_ptr);
	
	printf("the value of int_ptr is now 0x%p.\n",int_ptr);
	printf("the value of myint is now %p.\n",&myint);
	
	
	printf("the value char to pointer is %c.\n",*char_ptr);
	printf("the value int to pointer  is 0x%x.\n",*int_ptr);
