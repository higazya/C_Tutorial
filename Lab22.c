/*
 ...
 ========================================================
 Implement a program that demonstrates type casting
 ============================================================================
*/
#include <stdio.h>
...
int main()
{
	...
	printf("the value of char ptr is now %c.\n",*((char*)ptr));
	
	//TODO: ptr has address of integer data
	//TODO: ptr has address of float data
